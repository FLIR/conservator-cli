...
#               Stats
# -------------------------------------
def show_help(default_config_path: str, config_filename: str, logger: logging.Logger) -> None:
    """
    ...
    for config_folder in config_folders:
        ...
        with open(config_path, encoding="UTF-8") as config_file:
            try:
                ...
                logger.warning(f'Could not parse JSON file: "{config_path}" with error: {e}')
...
def main():
    ...
    #               Logging
    # -------------------------------------
    logger: logging.Logger = logging.getLogger("upload")
    ...
    main_helper(args, upload_config_root, logger, dry_run)

    if dry_run:
        logger.info("---------------------------------------------------------------------------")
        logger.info(" NOTE: No data was uploaded. Set --dry_run=false to upload")
        logger.info("---------------------------------------------------------------------------")
