class DefaultMetadata:
    ...
    def get_tags(self, camera_name_or_spectrum: str) -> list:
        """
        A preset can represent a capture from multiple frame-synced cameras so provide a camera name
        However in the generic case we assume a single default camera, so camera name is not required
