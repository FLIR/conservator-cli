...
class Mutation(sgqlc.types.Type):
    ...
    delete_frames_by_search_query = sgqlc.types.Field(
        sgqlc.types.non_null(Dataset),
        graphql_name="deleteFramesBySearchQuery",
        args=sgqlc.types.ArgDict(
            (
                (
                    "dataset_id",
    ...
    accept_dataset_annotation = sgqlc.types.Field(
        sgqlc.types.non_null(DatasetAnnotation),
        graphql_name="acceptDatasetAnnotation",
        args=sgqlc.types.ArgDict(
            (
                (
                    "input",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(AcceptDatasetAnnotationInput),
                        graphql_name="input",
                        default=None,
                    ),
                ),
...
class Query(sgqlc.types.Type):
    ...
    __field_names__ = (
        ...
        "repository_by_dataset_id",
        "repositories_by_user_id",
        "conservator_stats",
        "all_stats",
        "last_nstats",
    ...
    favorite_collections = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(Collection)),
        graphql_name="favoriteCollections",
    )
    ...
    repository_by_dataset_id = sgqlc.types.Field(
        "Repository",
        graphql_name="repositoryByDatasetId",
        args=sgqlc.types.ArgDict(
            (
                (
                    "dataset_id",
    ...
    repositories_by_user_id = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of("Repository")),
        graphql_name="repositoriesByUserId",
        args=sgqlc.types.ArgDict(
            (
                (
                    "user_id",
