...
from FLIR.conservator_cli.lib.graphql_api import get_videos_by_collection_id, get_images_by_collection_id, \
    get_media_by_collection_id
from FLIR.conservator_cli.lib.graphql_api import get_videos_from_collection, get_images_from_collection, \
    get_media_from_collection
from FLIR.conservator_cli.lib.graphql_api import get_videos_from_filename, get_images_from_filename, \
